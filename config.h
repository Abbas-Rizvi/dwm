...
static const char *fonts[]          = { "Liberation Mono Regular:size=11:antialias=true:autohint=true", "Noto Color Emoji-11"};
...
static const char swalsymbol[] = "w";
...
static const char *screenshot[]  = { "gscreenshot-cli", "-sc", NULL };
